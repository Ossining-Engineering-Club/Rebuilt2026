...
public class PhoenixUtil {
  ...
  public static SwerveModuleConstants regulateModuleConstantForSimulation(
    ...
    return moduleConstants
        ...
        .withDriveFrictionVoltage(DriveConstants.driveFrictionVoltage)
        .withSteerFrictionVoltage(DriveConstants.steerFrictionVoltage)
        // Adjust steer inertia
        .withSteerInertia(DriveConstants.steerInertia);
  }
}
